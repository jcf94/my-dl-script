...
tf.app.flags.DEFINE_string('worker_hosts', '192.168.0.10:50000,192.168.0.11:50000', 'Comma-separated list of target hosts')
...
class BenchMark(object):
    def __init__(self):
        ...
        def fake_input_fn():
            ...
            # ----------------------- Fake Input Images -----------------------
            with tf.device(self.cpu_device[0]), tf.name_scope('Fake_Input_Images'):
                ...
                return tf.data.Dataset.zip((images, labels)).prefetch(10)
