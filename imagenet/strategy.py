...
class LocalPSStagingStrategy(object):
    def __init__(self, BenchMark):
        tf.logging.info('Using LocalPSStagingStrategy')
...
class DistributedPSStrategy(object):
    def __init__(self, BenchMark):
...
class DistributedPSStagingStrategy(object):
    def __init__(self, BenchMark):
        tf.logging.info('Using DistributedPSStagingStrategy')
